<!-- Modal -->
<div class="modal fade" id="addPermissionModal" aria-hidden="false" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" method="POST" action="{{url('res/roles-and-permissions/add-permission')}}">
                   @csrf
